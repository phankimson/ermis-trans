var Ermis = function () {
    ...
    var initKendoUiUpload = function () {
        ...
        jQuery("#image").kendoUpload({ "multiple": true });
    };
                ...
                if (confirmed) {
                    ...
                    if (crit === true) {
                      ...
                      if(a){
                        ...
                        for(var i = 0 ; i < a[0].files.length ; i++){
                          var b = a[0].files[i];
                          fd.append('image[]', b);
                        }
    ...
    var onChange = function () {
        ...
        jQuery.each(data.columns, function (k, col) {
            if (col.key === 'text' || col.key === 'password' || col.key === 'number') {
                ...
                } else if (jQuery('input[name = ' + col.field + ']').hasClass("datetime")) {
                    jQuery('input[name="' + col.field + '"]').val(formatDate(dataItem[col.field]));
