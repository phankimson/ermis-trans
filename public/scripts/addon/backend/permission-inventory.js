var Permission = function () {
    ...
    var change_user = function (e) {
        ...
        var ids = jQuery("#inventory").val();
        var postdata = { data: JSON.stringify({'id':id,'ids':ids}) };
                    ...
                    if (user !=="") {
                        ...
                        jQuery('.uk-table tr.item').each(function (i, obj) {
                            ...
                            jQuery.each(items, function (y,o) {
                                ...
                                aryData.push({ "permission": permission, "inventory" : inventory ,"menu": menu, "user": user, "id": id });
                        });
    ...
    var initStatus = function (e) {
        ...
        jQuery('#inventory').on('change', change_user);
    };
    return {
