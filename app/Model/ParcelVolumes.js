...
class ParcelVolumes extends Lucid {

  static boot () {
   super.boot()
   this.addHook('beforeCreate', 'ParcelVolumes.validate')
   this.addHook('beforeUpdate', 'ParcelVolumes.validate')
 }
  static get table () {
    return 'parcel_volumes'
  }
