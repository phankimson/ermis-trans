...
class TransferIssueInventoryVoucherController{
  constructor () {
    ...
    * show (request, response){
        ...
        const show = yield response.view('pos/pages/transfer_issue_inventory_voucher', {key : this.key ,title: title ,driver : driver.toJSON() , transport : transport.toJSON(), voucher : voucher, item : item.toJSON() , print : print.toJSON() , stock : stock.toJSON()})  // EDIT
        response.send(show)
    }
