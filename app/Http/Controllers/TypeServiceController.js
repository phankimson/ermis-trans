'use strict'
const Data = use('App/Model/TypeService')  // EDIT
const Antl = use('Antl')
...
class TypeServiceController{
  constructor () {
      this.type = ""  // EDIT
      this.key = "type-service"  // EDIT
      this.menu = "trans_type_service"  // EDIT
      this.download = "TypeService.xlsx"  // EDIT
      this.room = "type-service"  // EDIT
    }
