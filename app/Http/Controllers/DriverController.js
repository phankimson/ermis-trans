'use strict'
const Data = use('App/Model/Driver')  // EDIT
const Antl = use('Antl')
...
class DriverController{
  constructor () {
      this.type = ""  // EDIT
      this.key = "driver"  // EDIT
      this.menu = "trans_driver"  // EDIT
      this.download = "Driver.xlsx"  // EDIT
      this.room = "driver"  // EDIT
    }
  * show (request, response){
      const title = Antl.formatMessage('driver.title')  // EDIT
      const data = yield Data.query().orderBy('id', 'desc').fetch()
      const show = yield response.view('pos/pages/driver', {key : this.key ,room : this.room,title: title , data: data.toJSON()})  // EDIT
      response.send(show)
  }
