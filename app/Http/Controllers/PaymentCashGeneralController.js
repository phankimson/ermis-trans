...
class PaymentCashGeneralController{
  constructor () {
      this.type = 8  // EDIT Payment = 8
      this.key = "payment-cash-general"  // EDIT
      this.menu = "pos_payment_cash"
      this.print = 'PCCN%'
    }
  * show (request, response){
      const title = Antl.formatMessage('payment_cash_general.title')  // EDIT
      ...
      const show = yield response.view('pos/pages/payment_cash_general', {key : this.key ,title: title , data: data.toJSON() , end_date : end_date , start_date : start_date , print : print.toJSON() })  // EDIT
      response.send(show)
  }
...
module.exports = PaymentCashGeneralController
