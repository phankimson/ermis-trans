'use strict'
const Data = use('App/Model/SalesStaff')  // EDIT
const Antl = use('Antl')
...
class SalesStaffController{
  constructor () {
      this.type = ""  // EDIT
      this.key = "sales-staff"  // EDIT
      this.menu = "trans_sales_staff"  // EDIT
      this.download = "SalesStaff.xlsx"  // EDIT
      this.room = "sales-staff"  // EDIT
    }
...
module.exports = SalesStaffController
