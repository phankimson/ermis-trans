...
class ReceiptCashVoucherController{
  constructor () {
    ...
    * show (request, response){
        ...
        const show = yield response.view('pos/pages/receipt_cash_voucher', {key : this.key ,title: title , reasons : reasons.toJSON() , voucher : voucher, print : print.toJSON()})  // EDIT
        response.send(show)
    }
