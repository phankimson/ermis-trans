'use strict'
const Data = use('App/Model/Distric')  // EDIT
const Antl = use('Antl')
...
class DistricController{
  constructor () {
      this.type = ""  // EDIT
      this.key = "distric"  // EDIT
      this.menu = "trans_distric"  // EDIT
      this.download = "Distric.xlsx"  // EDIT
      this.room = "distric"  // EDIT
    }
...
module.exports = DistricController
