...
class ReportListSuplierController{
  ...
  * show (request, response){
      ...
      const show = yield response.view('pos/pages/report_list_suplier', {key : this.key ,room : this.room ,title: title ,end_date:end_date , start_date :start_date , subject:subject.toJSON()})  // EDIT
      response.send(show)
  }
