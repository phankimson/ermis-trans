...
class ReportGeneralDebtSuplierController{
  ...
  * show (request, response){
      ...
      const show = yield response.view('pos/pages/report_general_debt_suplier', {key : this.key ,title: title , end_date:end_date , start_date :start_date  , subject : subject.toJSON() })  // EDIT
      response.send(show)
  }
