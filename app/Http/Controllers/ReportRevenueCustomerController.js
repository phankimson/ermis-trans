...
class ReportRevenueCustomerController{
  ...
  * show (request, response){
      ...
      const show = yield response.view('pos/pages/report_revenue_customer', {key : this.key ,room : this.room ,title: title, sale_staff : sale_staff.toJSON(), start_date:start_date  , end_date:end_date , subject:subject.toJSON()})  // EDIT
      response.send(show)
  }
