'use strict'
const Data = use('App/Model/ObjectGroup')  // EDIT
const Antl = use('Antl')
...
class ObjectGroupController{
  constructor () {
      this.type = 1  // EDIT
      this.key = "object-group"  // EDIT
      this.menu = "pos_object_group"  // EDIT
      this.download = "ObjectGroup.xlsx"  // EDIT
      this.room = "object-group"  // EDIT
    }
  * show (request, response){
      ...
      const show = yield response.view('pos/pages/object_group', {key : this.key ,room : this.room ,title: title , data: data.toJSON()})  // EDIT
      response.send(show)
  }
...
module.exports = ObjectGroupController
