'use strict'
const Data = use('App/Model/TypeTransport')  // EDIT
const Antl = use('Antl')
...
class TypeTransportController{
  constructor () {
      this.type = ""  // EDIT
      this.key = "type-transport"  // EDIT
      this.menu = "trans_type_transport"  // EDIT
      this.download = "TypeTransport.xlsx"  // EDIT
      this.room = "type-transport"  // EDIT
    }
